...
class Trainer:
    ...
    def one_update_weights(self, replay_buffer, shared_storage, writer , train_step, num = 1):
        for _ in range(num):
            batch_info = replay_buffer.get_batch()
            if batch_info is None or batch_info[0] is None:
                return
            index_batch, batch = batch_info
            self.update_lr()
            # self.update_lr()
        ...
        # writer.add_scalar('3.Loss/Value_loss',shared_storage.get_info('value_loss') , train_step)
        # writer.add_scalar('3.Loss/Reward_loss',shared_storage.get_info('reward_loss') , train_step)
        # writer.add_scalar('3.Loss/Policy_loss',shared_storage.get_info('policy_loss') , train_step)
    ...
    def continuous_update_weights(self, replay_buffer, shared_storage):
        ...
        #     time.sleep(0.1)
        # print(shared_storage.get_info("terminate"))
        # while shared_storage.get_info("num_played_games") < 1:
        #     # print(shared_storage.get_info("num_played_games"))
        #     time.sleep(0.1)
